...
- [Linux amd64](https://github.com/gentee/gentee/releases/download/v1.0.0-rc.1/gentee-1.0.0-rc.1-linux-amd64.zip)
- [Windows amd64](https://github.com/gentee/gentee/releases/download/v1.0.0-rc.1/gentee-1.0.0-rc.1-windows-amd64.zip)
- [macOS amd64](https://github.com/gentee/gentee/releases/download/v1.0.0-rc.1/gentee-1.0.0-rc.1-darwin-amd64.zip)
